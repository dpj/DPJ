...
public class Main {
	...
	if (args.length > 0 && args[0].equals("-dpj")) {
	    String[] newargs = new String[args.length-1];
	    System.arraycopy(args, 1, newargs, 0, args.length-1);
	    System.exit(compileDPJ(newargs));
	} else if (args.length > 0 && args[0].equals("-Xjdb")) {
	...
	return compiler.compile(args, false);
    }

    public static int compileDPJ(String[] args) {
	com.sun.tools.javac.main.Main compiler =
	    new com.sun.tools.javac.main.Main("dpjc");
	return compiler.compile(args, true);
    }
