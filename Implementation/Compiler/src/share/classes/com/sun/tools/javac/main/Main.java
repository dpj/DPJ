...
public class Main {
     ...
     */
    public int compile(String[] args, boolean DPJ) {
        Context context = new Context();
        JavacFileManager.preRegister(context); // can't create it until Log has been set up
        int result = compile(args, context, DPJ);
   ...
   public int compile(String[] args, Context context, boolean DPJ) {
        return compile(args, context, List.<JavaFileObject>nil(), null, DPJ);
    }
